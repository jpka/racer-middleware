module.exports = function(opts) {
  ...
  b = require("racer/node_modules/browserify")(__dirname + "/client.js"),
  modelMiddleware = store.modelMiddleware(store),
  racerBrowserChannel = require("racer-browserchannel")(store),
  storeBundle;

  b.require("node-uuid"); //We need to replace racer's uuid because the version that it uses breaks when required via AMD.
